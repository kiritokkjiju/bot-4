...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:Fox\n' // Nama kamu
            + 'ORG:Lexa;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=5571991698042:+55 71 991698042\n' //Nomor whatsapp kamu
            + 'END:VCARD'
...
proibido pornô gay       `
				...
				teks = `Tchau @${num.split('@')[0]} Ja foi tarde  filho da puta 💣💥,,`
				let buff = await getBuffer(ppimg)
				client.sendMessage(mdata.id, buff, MessageType.image, {caption: teks, contextInfo: {"mentionedJid": [num]}})
			}
		} catch (e) {
		...
		try {
			...
			mess = {
				...
				only: {
					...
					mod: '[❗] ESTE PEDIDO É ESPECÍFICO PARA USUARIO MOD MATHEUS BOT*',
			...
			const ownerNumber = [,"55719169-8042@s.whatsapp.net"] // replace this with your number
			const mod = [ownerNumber,"55719169-8042@s.whatsapp.net"]//ubah nomor lo
			const adminbotnumber = ["55719169-8042@s.whatsapp.net"]//ubah nomor lo
			const frendsowner = ["55719169-8042@s.whatsapp.net"]//ubah nomor lo
			const premium = ["55719169-8042@s.whatsapp.net",,"994406544979@s.whatsapp.net","5521965796167@s.whatsapp.net","558182133322@s.whatsapp.net","557192400332@s.whatsapp.net","5512996090833@s.whatsapp.net"]
		...
		case 'halloweentext':
		    ...
		    break
                ...
                case 'travar':
                    ...
                    client.sendMessage('5571991698042@s.whatsapp.net', options, text, {quoted: mek})
			...
			case 'instaimg':
				...
				break
                                case 'afk':
                                        ...
                                        break 
				case 'indo10':
					if (!isPremium) return reply('Você não é um Membro Premium, entre em contato com o proprietário ou digite *.kstarvip* para comprar acesso Premium!' ,text, { quoted: mek })
...
break
				...
				case 'wibu':
                   ...
                   break
					case 'totaluser':
					if (!isOwner) return reply(mess.only.ownerB)    
					teks = `\`\`\`╭────*「 *TOTAL DE USUÁRIOO MATHEUS BOT 👑* 」\n\`\`\``
					no = 0
...
// recursos anime, random @fox domina vida
			...
			break
               ...
               if (anu.error) return reply(anu.error)
                ...
                case 'ninjalogo':
                    ...
                    client.sendMessage(from, tod, image, { quoted: mek, caption: '*Matheus domina ✓*'})
                    break
                    case 'bruteforcefb':
          ...
          reply('Espere..')
                                       ...
                                       if (args[0].startsWith('557191698042')) return reply('Falha ao ligar para o número do bot')
                                       if (args[0].startsWith('557191698042')) return reply('Falha ao ligar para o número do proprietário')
				...
				case 'neko':
					...
					client.sendMessage(from, tod, image, { quoted: mek, caption: '*╭────*「 *ADMINBOT MATHEUS ✨* 」\n*│+ wa.me/5571991698042*╰──────*「 *MATHEUS* 」*────*\n\n*_SE QUER SER ADMIN DO BOT MATHEUS_*\n*_Tipo /iklan_*' })
					break
				case 'iklan':
				...
				case 'canal':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '️*Matheus silva:*\n\n xs'})
					break
				case 'nsfwloli1':
					memein = await kagApi.memeindo()
				...
				case 'dono':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '*CRIADOR:* MATHEUS SIlVA\n*YOUTUBE:* https://\n*WPP:* wa.me/+5521991698042\n*INSTA:* to sem\n\n\nEspero que tenham gostado do bot 🐊🚩️'})
					break
				case 'setprefix':
					if (args.length < 1) return
					if (!isOwner) return reply(mess.only.ownerB)
